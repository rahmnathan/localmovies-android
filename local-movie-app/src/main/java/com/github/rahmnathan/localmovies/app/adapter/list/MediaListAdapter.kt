...
import com.github.rahmnathan.localmovies.app.adapter.list.ListAdapterUtils.mapRatingsToView
import com.github.rahmnathan.localmovies.app.adapter.list.ListAdapterUtils.mapTitleToView
import com.github.rahmnathan.localmovies.app.adapter.list.ListAdapterUtils.mapYearToView
import com.github.rahmnathan.localmovies.app.adapter.list.ListAdapterUtils.sort
...
class MediaListAdapter(private val context: Activity, private var media: MutableList<Media>) : ArrayAdapter<Media?>(context, R.layout.my_adapter, media as List<Media?>), Filterable {
    ...
    fun filterGenre(genre: MovieGenre) {
